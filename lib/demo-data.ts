...
export const universities: University[] = [
  ...
  },
  {
    ...
    description:
      "World-renowned science and technology university. Consistently ranked in the global top 10. Rigorous, research-intensive environment with strong industry ties.",
    studentCount: 23000,
    scores: {
      overall: 4.6,
      teaching: 4.4,
    ...
    reviewCount: 163,
    tags: ["STEM", "Research", "World-class", "Expensive"],
  },
  {
    id: "lmu",
...
export const reviews: Review[] = [
  ...
  // ETH reviews
  {
    ...
    targetType: "university",
    targetId: "eth",
    authorAlias: "M.Sc. Physics",
    year: 2024,
    rating: 5,
    title: "Exceptional if you can handle the pace",
    body: "ETH is as demanding as the reputation suggests. The first semester felt brutal but the academic community is truly world-class. If you have the grades and drive to get in, do it.",
    pros: "World-class research, facilities, alumni network",
    cons: "Highly competitive, very expensive, pressure is constant",
    verified: true,
  },
  // Course reviews
  {
